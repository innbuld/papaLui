  ...
  return (
    <div className="wrap py-16">
      <div className="img-wrap">
        <img src="/pop.jpeg" className="w-[100px] mx-auto" alt="PLUG-AI" />
      </div>
      ...
      <div className="wrap mt-16 text-center p-5">
        ...
        <h1 className="lg:text-8xl text-4xl font-extrabold my-5 mt-3 font-jumb">
          MEet $PLUG
        </h1>
        <span className="italic text-3xl">
          $Meet Papa Luigi, the crypto #DOGEFATHER behind $LUIGI, $WALUIGI,
          $WARIO, and $YOSHI.{" "}
        </span>
      </div>
      ...
      <div className="btn-wrap text-center my-10 ">
        <a
          href="https://www.dexscreener.com/solana/"
          className="p-4 px-7 border border-black font-jumb text-[black]"
        >
          DexScreener
        </a>
      </div>
      <div className="btn-wrap text-center my-10 ">
        <a
          href="https://t.me/PapaLuigiAi_Bot"
          className="p-4 px-7 border border-black font-jumb text-[black]"
        >
          Bet $PLUG AI Now
        </a>
